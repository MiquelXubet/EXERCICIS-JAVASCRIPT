...
const notaMediaFinal = notaMedia;
...
if (notaMedia < 3.0) {
  ...
  notaFinal = "Notable";
} else if (notaMedia < 10.01) {
  notaFinal = "Sobresaliente";
} else {
  notaFinal = "Nota incorrecta";
}

console.log(notaFinal);
document.getElementById("nota_media").innerText = notaMedia.toFixed(2);
document.getElementById("nota_media_final").innerText =
  notaMediaFinal.toFixed(2);
